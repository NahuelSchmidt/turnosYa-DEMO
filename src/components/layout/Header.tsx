      ...
      <div className="container flex h-16 items-center mx-auto px-4">
        <div className="mr-auto flex items-center gap-2">
          <Link href="/" className="flex items-center gap-2.5 font-bold group">
            ...
            <span style={{ fontFamily: 'PT Sans, sans-serif', letterSpacing: '0.04em', fontSize: '1.2rem', fontWeight: 700 }}>Turnify</span>
          </Link>
        </div>
            ...
            <SheetContent side="left" className="rounded-r-3xl">
              <div className="flex flex-col gap-8 pt-10">
                <Link href="/" className="flex items-center gap-3 font-bold px-2">
                  ...
                  <span style={{ fontFamily: 'PT Sans, sans-serif', letterSpacing: '0.04em', fontSize: '1.4rem', fontWeight: 700 }}>Turnify</span>
                </Link>
                {isRealUser && plan && (
                  <div className="px-2">
